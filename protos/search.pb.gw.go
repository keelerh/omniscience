...
func request_Search_ListServices_0(ctx context.Context, marshaler runtime.Marshaler, client SearchClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterSearchHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SearchClient) error {
	...
	mux.Handle("POST", pattern_Search_ListServices_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Search_ListServices_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Search_ListServices_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Search_ListServices_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "omniscience", "services"}, ""))
)

var (
	forward_Search_ListServices_0 = runtime.ForwardResponseMessage
)
